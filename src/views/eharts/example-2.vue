			...
			<div v-else class="host-body">
				<div class="d-flex jc-center">
					...
					<div class="d-flex jc-center">
						...
						<div class="title">
							<span class="title-text">彩云居家实时数据</span>
				...
				<div class="flex-col flex-col-item" style="min-height: 700px;">
					<div class="flex-col-6" style="height: 100%;!important ">
						...
						<div class="row" style="height: 60%;!important ">
							...
							<!-- <centerRight2 style="height: 100%;"/> -->
								<StackGraph style="height: 100%;"/>
							</dv-border-box-13>
						</div>
					</div>
					<div class="flex-col-8" style="min-height: 100%;">
						<dv-border-box-12 style="height: 100%;">
							<Map />
							<!-- <centerLeft2/> -->
						</dv-border-box-12>
						...
						<div class="row" style="height: 100%;!important">
							<dv-border-box-12 style="height: 100%;!important">
								<div  class=" row" style="height: 100%;">
									<div class="flex-col-24" style="height: 25%;">
										<tags style="height: 100%;"></tags>
									</div>
									<div class="flex-col-24" style="height: 75%;">
