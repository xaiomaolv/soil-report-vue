<template>
	<div id="centerLeft1">
		<div class="bg-color-black">
			<div class="flex-col pd-tb-5 pd-lr-10">
				<icon name="chart-bar" style="color:#5cd9e8"></icon>
				<span class="fs-xl text mx-2">分行签约小区数量统计</span>
				<dv-decoration-3 style="width:1.25rem;height:.25rem; position:relative;top:-.0375rem;" />
			</div>
			

			<CenterLeft1Chart style="height: calc(100% - 30px)"/>
