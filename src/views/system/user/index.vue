    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        >
          ...
          <el-form-item label="统一认证号" prop="unifyId">
            <el-input
              v-model="queryParams.unifyId"
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 5, label: `微信openid`, visible: true },
        { key: 6, label: `统一认证号`, visible: true },
  ...
  methods: {
    ...
    handleFileSuccess(response, file, fileList) {
      response = this.decryptVerifySign(response);
