...
<script>
import { reportShareAdd } from "@/api/report/reportShare";
import { getDictList } from "@/api/report/dict-data"; // 获取数据字典
import Dictionary from "@/components/report/Dictionary/index";
export default {
