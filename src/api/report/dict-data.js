...
import { setStorageItem } from '@/utils/report/storage'
// 数据字典和基础数据查询的相关接口
...
export function getDictList (type) {
  return request({
    url: `/report/gaeaDict/select/${type}`,
    method: 'get',
  })
}
export function getDictCodes (project) {
  return request({
    url: `/report/gaeaDict/selectAll/${project}`,
    method: 'get',
  })
}
